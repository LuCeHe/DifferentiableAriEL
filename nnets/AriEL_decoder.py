...
class DAriEL_Decoder_Layer_1(Layer):
...
class DAriEL_Decoder_Layer_0(object):
    ...
    def __call__(self, input_point):
        ...
        # unit hyper-cube
        unfolding_point = Lambda(clip_layer, arguments={'min_value': 0., 'max_value': self.size_latDim})(input_point)  # Clip(0., 1.)(input_point)
...
class DAriEL_Decoder_Layer_2(object):
    ...
    def __call__(self, input_point):        
        sentence_layer = Lambda(dynamic_filler, arguments={'d': self.max_senLen+1, 'value': int(self.PAD)})(input_point)        
        ...
        upp_bound = Lambda(dynamic_filler, arguments={'d': self.latDim, 'value': float(self.size_latDim)})(unfolding_point)
        ...
        for j in range(self.max_senLen):
            ...
            s, low_bound, upp_bound = FindSymbolAndBounds(self.vocabSize, curDim)([Ls, Us, low_bound, upp_bound, input_point])
