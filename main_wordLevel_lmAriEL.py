...
def checkAutoencoder(ae_model, valIndices):
    ...
    categorical_TF=True
    generator_class = w2n_generator(grammar, batch_size, maxlen=maxlen, categorical=categorical_TF)
...
def main(categorical_TF=True):
    ...
    generator_class = next_word_generator(grammar, batch_size, maxlen=maxlen, categorical=categorical_TF)
    generator = generator_class.generator()
